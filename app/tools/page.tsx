...
export default function ToolsPage() {
  ...
  const openAction = (kind: ActionKind, tool?: Tool) => { if (!currentAccount?.canIssue) { setModal({kind:'auth'}); toast.error('Sign in with an account allowed to issue equipment.'); return; } setSelectedId(null); setModal({ kind, tool }); };
