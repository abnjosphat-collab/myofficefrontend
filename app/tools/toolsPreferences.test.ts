...
describe('Tools preferences', () => {
  ...
  it('clamps text size and restores required sections', () => {
    ...
    expect(result).toMatchObject({ appearance: 'dark', options: { order: ['overview', 'register'], hidden: [], font: 'inter', fontSize: 130, equipmentIcons: 'iconoir', guidance: false, guide: true } });
  });
});
