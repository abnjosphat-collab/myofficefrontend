...
export type SearchTarget =
  ...
  | { type: 'modal'; modal: 'new' | 'employee' | 'customize' | 'import' | 'export' | 'feedback' }
...
const fixedResults: WorkspaceSearchResult[] = [
  ...
  { id: 'setting-customize', kind: 'Setting', title: 'Customize workspace', subtitle: 'Layout, type, icon style and guidance', keywords: 'settings preferences rearrange hide restore font icons help hints', icon: 'settings', target: { type: 'modal', modal: 'customize' } },
...
export function buildWorkspaceSearchIndex(tools: Tool[], employees: Employee[], activity: Activity[]) {
